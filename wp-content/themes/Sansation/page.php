...
<div id="interiorbanner"<?php $banner = get_option('ss_banner_height'); if ($banner != 'normal') { echo ' class="half-height"';} ?>>
	<div class="center">
		<h2 class="ptitle"><?php echo get_option('ss_blogtitle'); ?><?php the_title(); ?></h2>
...
<?php endif; ?>
		...
		<!--
		<div id="sidebar">
			<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar("Blog Sidebar") ) : ?><h3>BLOG SIDEBAR</h3><p><a href='get_bloginfo('wpurl'); ?>/wp-admin/widgets.php'>Widgetize this sidebar</a>
			<?php endif; ?>
